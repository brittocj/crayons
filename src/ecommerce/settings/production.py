...
EMAIL_HOST_USER = 'britsonnet@gmail.com' 
EMAIL_HOST_PASSWORD = 'briOtt@9'
EMAIL_PORT = '587'
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'Brits email <britsonnet@gmail.com>'
BASE_URL = 'https://www.pythonanywhere.com/brittocj'
...
#STATIC_ROOT = os.path.join(BASE_DIR, "static_my_proj")
